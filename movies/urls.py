...
from .views import movie_detail, movie_list, toggle_favorite, movie_detail_api, trending_movies, get_favorite_movies 
...
urlpatterns = [
    ...
    path("get_favorite_movies/", get_favorite_movies, name="get_favorite_movies"),
